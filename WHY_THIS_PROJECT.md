...
**Marketing Content Team AI Assistant** is not a static prompt demo. It is a runnable full-stack AI application for **Marketing Content Team** that demonstrates the core expectations of a **Multi-Agent AI** project at **Intermediate** difficulty.
...
- A service pipeline runs the expected project flow: Content Agent, Approval Agent.
