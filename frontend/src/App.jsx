...
const PROJECT_SUBJECT = "Marketing Content Team";
const DOMAIN_SUMMARY = "Marketing content creation and review process involves multiple stakeholders and tasks. This project aims to automate content creation, review, and approval using multi-agent AI.";
const USER_PERSONA = "Marketing Team Lead: Responsible for managing marketing content creation and review process";
const STARTER_QUESTIONS = ["What is the marketing content creation process?", "How can we automate content creation and review?", "What are the key performance indicators (KPIs) for marketing content?"];
